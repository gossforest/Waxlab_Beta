...
<img src="docs/screenshot_home.png" width="260" alt="Home screen showing events list with inline winner preview"/>
<br/><sub><b>Events</b> — home screen with inline winner preview</sub>
</td>
<td align="center" width="33%">
<img src="docs/screenshot_tournament.png" width="260" alt="Tournament tab showing head-to-head pairing panel"/>
<br/><sub><b>Tournament</b> — head-to-head pairing with match history chips</sub>
</td>
<td align="center" width="33%">
<img src="docs/screenshot_raceday.png" width="260" alt="Race Day summary with all winners and conditions"/>
<br/><sub><b>Race Day</b> — winner summary with conditions and feel notes</sub>
</td>
</tr>
<tr>
<td align="center" width="33%">
<img src="docs/screenshot_glideout.png" width="260" alt="Glide Out comparison interface with live rankings"/>
<br/><sub><b>Glide Out</b> — side-by-side comparison with live rankings</sub>
</td>
<td align="center" width="33%">
<img src="docs/screenshot_waxroom.png" width="260" alt="Wax Room dashboard in dark mode with race countdown"/>
<br/><sub><b>Wax Room</b> — dark mode dashboard with race countdown and winners board</sub>
</td>
<td align="center" width="33%">
<img src="docs/screenshot_fleet.png" width="260" alt="Fleet registry with quick add convention picker"/>
<br/><sub><b>Fleet Registry</b> — quick add with naming convention picker</sub>
</td>
</tr>
</table>

> Screenshots are pixel-accurate mockups matching the app's exact color palette and typography. Replace with real device screenshots when available.
...
- Team Board: wax calls, alerts, and notes posted to a shared message feed. Browser notifications for alerts when the app is in the background.
